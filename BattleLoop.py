...
def battles (screen):
  ...
  image = pygame.image.load("C:\\Users\\orech\\Documents\\CHE120\\Game Images\\generated-image-1.png").convert()
  ...
  while(game):
    screen.blit(image, (50, 50))
    global level
    did_they_win = che120_questions.question_results(level, "1_100", screen)
